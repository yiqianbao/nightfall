const tokenMapper = ({
  ...
  return {
    ...
    token_commitment_index: ((token_index || token_index===0)? token_index : ((z_A_index || z_A_index===0) ? z_A_index : undefined)),
...
const joinTokenMapper = ({
  ...
  return {
    ...
    token_commitment_index: (data.z_B_index || data.z_B_index===0) ? data.z_B_index : ((z_A_index || z_A_index===0) ? z_A_index : undefined),
    root_name: (rootName) ? rootName.toLowerCase() : undefined,
    timestamp: new Date(),
    receiver_public_key: (pk_B) ? pk_B.toLowerCase() : undefined,
    receiver_name: (receiver_name || '').toLowerCase(),
