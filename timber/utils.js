...
const pedersenHash = require("../src/pedersenHashCallGo.js");
...
function concatenateThenHash(...items) {
  ...
  console.log("input is", concatvalue.toString("hex"));
  let hash = pedersenHash.pedersenHashCallGo(concatvalue);
  console.log("output is", hash.toString("hex"));
